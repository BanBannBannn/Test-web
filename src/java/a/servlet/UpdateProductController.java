...
public class UpdateProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String featrue = request.getParameter("featrue");
            ...
            if (checkValidation) {
                boolean isSale = Boolean.parseBoolean(sale);
                ProductDAO dao = new ProductDAO();
                ProductDTO productUpdate = new ProductDTO(proID, name, description, featrue, price, quantity, srcImg, isSale);
