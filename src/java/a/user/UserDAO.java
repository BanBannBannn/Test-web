...
public class UserDAO {
    ...
    private static final String CHECK_EXISTED = "SELECT userID FROM Users where userID =?";
    private static final String INSERT = "INSERT INTO Users(userID, fullname, roleID, password) VALUES(?,?,'US',?)";
    ...
    public boolean insert(String userID, String fullName, String password) throws SQLException {
        Connection conn = null;
        PreparedStatement ptm = null;
        try {
            conn = DBUtils.getConnection();
    ...
    public boolean update(String fullName, String roleID, String userID) throws SQLException {
        Connection conn = null;
        PreparedStatement ptm = null;
        try {
            conn = DBUtils.getConnection();
